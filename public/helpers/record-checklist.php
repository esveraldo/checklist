...
$fields = array($rsocial, $cnpj, $endereco, $contato, $telefone, $email, $bilhetagem, $relatorios, $listagem, $regras_imp,
                $pool, $cotas, $alerta_cotas, $policy, $lib_cracha, $chargerback, $tracking, $releaser, $dispositivos_liberacao,
                $implementacao, $instalacao, $sites, $impressao, $sem_server_imp, $sis_op, $comunicacao_entre_sites, 
                $user_autentic_estacoes, $imp_rede_usb, $licenca_sql_server, $instalar_sql_server_express, $server_dominio_autenticacao,
                $importacao_dominio, $qtde_users, $qtde_contas, $qtde_grupos, $qtde_estacoes_trabalho, $sis_op_est_trabalho, $navegadores_utilizados,
